      ...
      {ranked.map((p, i) => {
        ...
        return (
          <motion.div
            ...
            active ? 'border-gold-400/70 bg-ink-700' : 'border-white/10 bg-ink-800/70'}`
            }>
            
            {active &&
            <motion.span
              layoutId="scorebar-active"
              className="absolute inset-0 -z-0 bg-gold-400/10" />
            ...
            <div className="relative z-10 flex items-center gap-2">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex items-center gap-2 text-[10px] font-semibold text-white/55">
                  ...
                  <span className="flex items-center gap-0.5"><Coins size={11} className="text-gold-400" />{p.assets}</span>
